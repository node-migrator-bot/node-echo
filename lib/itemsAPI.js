...
var ItemsAPI = Class.extend({
     ...
     ,init:function(){
        ...
        this.TYPE_ARTICLE = "http://activitystrea.ms/schema/1.0/article";
        this.TYPE_COMMENT = "http://activitystrea.ms/schema/1.0/comment";
        this.TYPE_NOTE = "http://activitystrea.ms/schema/1.0/note";
        this.TYPE_STATUS = "http://activitystrea.ms/schema/1.0/status";
     }
    /* **************************************
     *            Search                    *
     ************************************** */
...
//            console.log(data)
    ...
    ,tagArticle: function(target,tag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.tag({id:target,type:this.TYPE_ARTICLE},tag,user,callback)
    }
    ,untagArticle: function(target,tag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.untag({id:target,type:this.TYPE_ARTICLE},tag,user,callback)
    }
    ,likeArticle: function(target,like,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.like({id:target,type:this.TYPE_ARTICLE},like,user,callback)
    }
    ,unlikeArticle: function(target,like,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.unlike({id:target,type:this.TYPE_ARTICLE},like,user,callback)
    }
    ,flagArticle: function(target,flag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.flag({id:target,type:this.TYPE_ARTICLE},flag,user,callback)
    }
    ,unflagArticle: function(target,flag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.tag({id:target,type:this.TYPE_COMMENT},tag,user,callback)
    }
    ,untagComment: function(target,tag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.untag({id:target,type:this.TYPE_COMMENT},tag,user,callback)
    }
    ,likeComment: function(target,like,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.like({id:target,type:this.TYPE_COMMENT},like,user,callback)
    }
    ,unlikeComment: function(target,like,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.unlike({id:target,type:this.TYPE_COMMENT},like,user,callback)
    }
    ,flagComment: function(target,flag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.flag({id:target,type:this.TYPE_COMMENT},flag,user,callback)
    }
    ...
    ,tagNote: function(target,tag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.tag({id:target,type:this.TYPE_NOTE},tag,user,callback)
    }
    ,untagNote: function(target,tag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.untag({id:target,type:this.TYPE_NOTE},tag,user,callback)
    }
    ,likeNote: function(target,like,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.like({id:target,type:this.TYPE_NOTE},like,user,callback)
    }
    ,unlikeNote: function(target,like,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.unlike({id:target,type:this.TYPE_NOTE},like,user,callback)
    }
    ,flagNote: function(target,flag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.flag({id:target,type:this.TYPE_NOTE},flag,user,callback)
    }
    ,unflagNote: function(target,flag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.tag({id:target,type:this.TYPE_STATUS},tag,user,callback)
    }
    ,untagStatus: function(target,tag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.untag({id:target,type:this.TYPE_STATUS},tag,user,callback)
    }
    ,likeStatus: function(target,like,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.like({id:target,type:this.TYPE_STATUS},like,user,callback)
    }
    ,unlikeStatus: function(target,like,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.unlike({id:target,type:this.TYPE_STATUS},like,user,callback)
    }
    ,flagStatus: function(target,flag,user,callback){
         ...
         * @param {function} callback callback called after submission
         */
        this.flag({id:target,type:this.TYPE_STATUS},flag,user,callback)
    }
