...
var ItemsAPI = Class.extend({
    ...
    ,submitArticle: function(article,user,callback){
        ...
        // Creating article
        var self = this;
        var myArticle = activityObjects.Article.spawn({item:article, user:user, feed:this.parameters.feed});
        // Rendering article then post it.
        myArticle.renderPost(function(err,data){
            self.itemsAPICore.submit(err,data,callback);
        })
    }
    ,tagArticle: function(article,tag,user,callback){
        /**
         * Tag an article
         * @method tagArticle
        ...
        update.content = tag;
        var self = this;
        var myArticle = activityObjects.Article.spawn({item:article_, user:user, feed:this.parameters.feed});
        // Rendering article then post it.
        myArticle.renderUpdate(update,function(err,data){
            self.itemsAPICore.submit(err,data,callback);
        })
    }
    ,untagArticle: function(article,tag,user,callback){
        /**
    ...
    ,markArticle: function(article,mark,user,callback){
        /**
    ...
    ,unmarkArticle: function(article,mark,user,callback){
        /**
    ...
    ,likeArticle: function(article,user,callback){
        /**
    ...
    ,unlikeArticle: function(article,user,callback){
        /**
    ...
    ,flagArticle: function(article,user,callback){
        /**
    ...
    ,unflagArticle: function(article,user,callback){
        /**
    ...
    ,updateArticle: function(article,user,callback){
        /**
    ...
    ,submitComment: function(comment,user,callback){
         ...
         */
        // Creating comment
        var myComment = activityObjects.Comment.spawn({item:comment, user:user, feed:this.parameters.feed});
        var self = this;
        // Rendering article then post it.
    ...
    ,tagComment: function(comment,tag,user,callback){
        /**
         * Tag an comment
         * @method tagComment
        ...
        update.type = "tag";
        update.content = tag;
        var myComment = activityObjects.Comment.spawn({item:comment_, user:user, feed:this.parameters.feed});
        // Rendering comment then post it.
        myComment.renderUpdate(update,function(err,data){
            self.itemsAPICore.submit(err,data,callback);
        })
    }
    ,untagComment: function(comment,tag,user,callback){
        /**
    ...
    ,markComment: function(comment,mark,user,callback){
        /**
    ...
    ,unmarkComment: function(comment,mark,user,callback){
        /**
    ...
    ,likeComment: function(comment,user,callback){
        /**
    ...
    ,unlikeComment: function(comment,user,callback){
        /**
    ...
    ,flagComment: function(comment,user,callback){
        /**
    ...
    ,unflagComment: function(comment,user,callback){
        /**
    ...
    ,updateComment: function(comment,user,callback){
        /**
    ...
    ,submitNote: function(note,user,callback){
         ...
         */
        // Creating note
        var myNote = activityObjects.Note.spawn({item:note, user:user, feed:this.parameters.feed});
        var self = this;
    ...
    ,tagNote: function(note,tag,user,callback){
        /**
         * Tag an note
         * @method tagNote
        ...
        update.type = "tag";
        update.content = tag;
        var myNote = activityObjects.Note.spawn({item:note_, user:user, feed:this.parameters.feed});
        // Rendering note then post it.
        myNote.renderUpdate(update,function(err,data){
            self.itemsAPICore.submit(err,data,callback);
        })
    }
    ,untagNote: function(note,tag,user,callback){
        /**
    ...
    ,markNote: function(note,mark,user,callback){
        /**
    ...
    ,unmarkNote: function(note,mark,user,callback){
        /**
    ...
    ,likeNote: function(note,user,callback){
        /**
    ...
    ,unlikeNote: function(note,user,callback){
        /**
    ...
    ,flagNote: function(note,user,callback){
        /**
    ...
    ,unflagNote: function(note,user,callback){
        /**
    ...
    ,updateNote: function(note,user,callback){
        /**
    ...
    ,submitStatus: function(status,user,callback){
         ...
         */
        // Creating status
        var myStatus = activityObjects.Status.spawn({item:status, user:user, feed:this.parameters.feed});
        var self = this;
        // Rendering article then post it.
    ...
    ,tagStatus: function(status,tag,user,callback){
        /**
         * Tag an status
         * @method tagStatus
        ...
        update.type = "tag";
        update.content = tag;
        var myStatus = activityObjects.Status.spawn({item:status_, user:user, feed:this.parameters.feed});
        // Rendering status then post it.
        myStatus.renderUpdate(update,function(err,data){
            self.itemsAPICore.submit(err,data,callback);
        })
    }
    ,untagStatus: function(status,tag,user,callback){
        /**
    ...
    ,markStatus: function(status,mark,user,callback){
        /**
    ...
    ,unmarkStatus: function(status,mark,user,callback){
        /**
    ...
    ,likeStatus: function(status,user,callback){
        /**
    ...
    ,unlikeStatus: function(status,user,callback){
        /**
    ...
    ,flagStatus: function(status,user,callback){
        /**
    ...
    ,unflagStatus: function(status,user,callback){
        /**
    ...
    ,updateStatus: function(status,user,callback){
        /**
