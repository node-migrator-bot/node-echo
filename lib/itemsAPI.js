...
function throwOptionsException(){
    throw { name: "Echo: Option not set exception", message: "itemsAPI requires the consumerKey option to be defined" };
}
...
var itemsAPI = function(options){
    /**
     * @class itemsAPI
     * @param {Object} options json object for options
...
itemsAPI.prototype.submitArticle = function(article,user,target,callback){
...
itemsAPI.prototype.markComment = function(marker,comment,user,callback){
    var date = ISODateString(new Date());
    var scope = this;
...
itemsAPI.prototype.post = function(url,data,callback){
    var self = this;
...
itemsAPI.prototype.responseHandler = function(error,data,response){
