...
ItemsAPI.prototype.submit = function(err,data,callback){
    /**
...
ItemsAPI.prototype.search = function(query, callback){
    ...
    throw { name : "Not implemented exception", error : "ItemsAPI.search is not implemented"}
};

ItemsAPI.prototype.count = function(){
    /**
     ...
     */
    var url = "/v1/count";
    throw { name : "Not implemented exception", error : "ItemsAPI.count is not implemented"}
};

ItemsAPI.prototype.mux = function(){
    /**
    ...
    var url = "/v1/mux";
        throw { name : "Not implemented exception", error : "ItemsAPI.mux is not implemented"}
