...
exports.req = function(){
    ...
    my.post = function(options,url,data,callback){
        ...
        switch (options.authMethod){
            ...
            case "basic":
                ...
                break;
            default:
                throw {name:'Illegal auth handler exception',error:'auth Handler '+options.authMethod+" not valid"}
        }
    };
    ...
    my.getOAuth = function(options,url,data,callback){
        ...
        console.log(require("util").inspect(reqoptions));
        console.log("---------------------------------------");
