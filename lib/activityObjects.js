...
var ActivityObject = Class.extend({
     ...
     */
     ...
     init: function(){
        ...
        if(!this.item.verb){
            this.verb = 'http://activitystrea.ms/schema/1.0/post';
...
var Article = ActivityObject.extend({
    /**
     * Article. Extends ActivityObject
     * @class Article
     * @param {object} properties. Specify:
     * <ul>
...
var Comment = ActivityObject.extend({
    /**
     * Comment. Extends ActivityObject
     * @class Comment
     * @param {object} properties. Specify:
     * <ul>
...
var Tag = ActivityObject.extend({
    /**
     * Tag/Untag. Extends ActivityObject
     * @class Tag
     * @param {object} properties. Specify:
     * <ul>
    ...
    init:function(){
        ...
        this.item.type = "http://activitystrea.ms/schema/1.0/tag";
    }
    ,renderItem : function(callback){
...
var Like = ActivityObject.extend({
    /**
     * Like/Unlike. Extends ActivityObject
     * @class Like
     * @param {object} properties. Specify:
     * <ul>
    ...
    init:function(){
        ...
        this.item.type = "http://activitystrea.ms/schema/1.0/like";
    }
    ,renderItem : function(callback){
...
var Flag = ActivityObject.extend({
    /**
     * Flag/Unflag. Extends ActivityObject
     * @class Flag
    ...
    init:function(){
        ...
        this.item.type = "http://activitystrea.ms/schema/1.0/flag";
    }
    ,renderItem : function(callback){
