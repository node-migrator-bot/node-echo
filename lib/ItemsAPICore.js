...
var ItemsAPICore = function(options){
    ...
    if(!options || !options.consumerKey || !options.consumerSecret) throw { name: "Options not set exception", message: "ItemsAPICore requires a consumerKey and a consumerSecret option to be defined" };
    this.options = {};
